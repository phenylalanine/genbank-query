 ...
 */
    ...
    BufferedReader readRemoteFile(String remotePath) {
        InputStream is = getRemoteStream(remotePath)
        return new BufferedReader(new InputStreamReader(is))
    }

    InputStream getRemoteStream(String remotePath) {
        return new MaybeCompressedInputStream(ftp.retrieveFileStream(remotePath))
    }
}
